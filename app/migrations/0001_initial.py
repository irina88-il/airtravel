# Generated by Django 4.2.5 on 2024-02-12 17:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.IntegerField(blank=True, choices=[(0, 'Не получилось определить'), (1, 'Отмена'), (2, 'Задержка'), (3, 'Вовремя')], null=True, verbose_name='Статус авиарейса')),
                ('status', models.IntegerField(choices=[(1, 'Введён'), (2, 'В работе'), (3, 'Завершен'), (4, 'Отклонен'), (5, 'Удален')], default=1, verbose_name='Статус')),
                ('date_created', models.DateTimeField(default=datetime.datetime(2024, 2, 12, 17, 3, 12, 94522, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
